...
const commandUsageText = [
    ...
    },
    {
        header: 'Dependencies',
        content: [
            'Node'.cyan + ' 16'.yellow + ' LTS'.cyan + ' (https://nodejs.org/en/blog/release/v16.16.0/)',
            'npm'.cyan + ' 8.5.5'.yellow,
            '@angular/cli'.cyan + ' ^9.1.15'.yellow,
        ]
    },
]
...
function install() {
    ...
    exec('npm install --legacy-peer-deps --force');
}
