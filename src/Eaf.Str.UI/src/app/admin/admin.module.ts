...
import { CreateOrEditDynamicParametersModalComponent } from './dynamic-parameters/create-or-edit-dynamic-parameters-modal.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CreateOrEditDynamicParametersModalComponent,
  ],
  exports: [],
  providers: [
