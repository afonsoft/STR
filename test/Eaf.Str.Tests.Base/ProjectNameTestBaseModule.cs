...
namespace Eaf.Str.Test.Base
{
    ...
    public class ProjectNameTestBaseModule : EafModule
    {
        public ProjectNameTestBaseModule(ProjectNameEntityFrameworkCoreModule eafTemplateEntityFrameworkCoreModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<ProjectNameDbMigrator>();
