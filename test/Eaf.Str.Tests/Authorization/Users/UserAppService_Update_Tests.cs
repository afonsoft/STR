...
namespace Eaf.Str.Tests.Authorization.Users
{
    ...
    public class UserAppService_Update_Tests : UserAppServiceTestBase
    {
        ...
        public async Task Update_User_Basic_Tests()
        {
            ...
            var adminUser = await GetUserByUserNameOrNullAsync(EafUserBase.AdminUserName);
            ...
            await UsingDbContextAsync(async context =>
            {
                ...
                updatedAdminUser.EmailAddress.ShouldBe("admin1@Eaf.com");
                updatedAdminUser.TenantId.ShouldBe(EafSession.TenantId);
                ...
                //Check roles
                updatedAdminUser.Roles.Count.ShouldBe(1); // Admin role is always assigned to admin user
        ...
        {
            return UsingDbContext(context => context.Roles.Add(new Role(EafSession.TenantId, roleName, roleName)).Entity);
        }
    }
}